...
import { useComposerAttachments } from "../uploads";
import { Card, Chip, EmptyState, GlassSurface, Input, PageTitle, Spinner } from "../ui";
import { AttachChips, AttachmentTray } from "../ui/attachments";
 ...
 * Rendered standalone at /kb (with a back button) and inside the supporter
 * Knowledge tab (without).
 */
export function KnowledgeBrowser({ showBack = false, title = "Knowledge base" }: { showBack?: boolean; title?: string }) {
